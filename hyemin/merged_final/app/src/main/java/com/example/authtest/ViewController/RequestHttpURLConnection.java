...
public class RequestHttpURLConnection {
    ...
    // 유저 정보 가져옴.
    public String request(String _url, ContentValues _params, String _report, Double _lat, Double _lng){
...
//            sbParams.append("report="+_report+"&password="+password);
            sbParams.append("report="+_report+"&lat="+_lat+"&lng="+_lng);
